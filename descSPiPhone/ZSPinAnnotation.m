...
//        [tagPath closePath];
         ...
         */
        [tagPath moveToPoint: CGPointMake(28, 35.5)];
        [tagPath addCurveToPoint: CGPointMake(38, 20.6) controlPoint1: CGPointMake(27.99, 35.51) controlPoint2: CGPointMake(38, 26.17)];
        [tagPath addCurveToPoint: CGPointMake(28, 10.5) controlPoint1: CGPointMake(38, 15.02) controlPoint2: CGPointMake(33.52, 10.5)];
        [tagPath addCurveToPoint: CGPointMake(18, 20.6) controlPoint1: CGPointMake(22.48, 10.5) controlPoint2: CGPointMake(18, 15.02)];
        [tagPath addCurveToPoint: CGPointMake(28, 35.5) controlPoint1: CGPointMake(18, 26.17) controlPoint2: CGPointMake(28, 35.5)];
        [tagPath addLineToPoint: CGPointMake(28, 35.5)];
        [tagPath closePath];
        [fillColor setFill];
        [tagPath fill];
